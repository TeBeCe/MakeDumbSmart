...
struct OtherFunctionDetailView: View {
    @State var newFunction: OtherNewFunction
...
struct OtherFunctionDetailView_Previews: PreviewProvider {
    static var previews: some View {
        OtherFunctionDetailView(newFunction: OtherNewFunction(id: 0, vendor: "Apple", deviceRealName: "AppleTV", functionName: "SwitchON/Off", rawData: "", rawDataLen: ""), nf: LoadJSONNewFunctionData(), dvcObj: LoadJSONData(), activeSheet: .constant(.first))
    }
}
