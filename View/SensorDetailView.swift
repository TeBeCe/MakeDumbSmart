...
struct SensorDetailView_Previews: PreviewProvider {
    static var previews: some View {
        SensorDetailView(sd: .constant(nil), dvcObj: LoadJSONData(), device: Device(id: 0, device_name: "Test Name", device: nil, reseting: false, glyph: "lightbulb" , is_active: true, type: "sensor_temperature", value: Float(Int(1.0)), max_level: 3, room: 1, processing: 0))
    }
}
