...
struct SensorDetailView_Previews: PreviewProvider {
    static var previews: some View {
        SensorDetailView(sd: .constant(nil), dvcObj: LoadJSONData(), device: Device(id: 0, device_name: "Test Name", device_custom_name: nil, glyph: nil , is_active: true, type: "Slider", value: Float(Int(1.0)), max_level: 3))
    }
}
